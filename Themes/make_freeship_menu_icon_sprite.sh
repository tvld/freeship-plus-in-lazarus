...
# we expect folder structure like:
#	/themes/default/Icons/svg
# 	/themes/default/Icons/16
# 	/themes/default/Icons/24

# Then, for example, if you want to convert all svg files in folder /themes/midnight-blue/Icons/svg There you can run it with:
...
do
	...
	do
		...
		mkdir -p ./${RES}
		# resize, remove semi transparent
